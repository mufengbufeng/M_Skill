...
public class PreloadProcedure : ProcedureBase
{
    ...
    private void InitAndLoadLanguage()
    {
        ...
        Log.Info(Utility.Text.Format("初始化游戏设置. 游戏语言:{0},系统语言:{1}", language, GFBuiltin.Localization.SystemLanguage));
    ...
    private void OnLoadConfigSuccess(object sender, GameEventArgs e)
    {
        ...
        if (args.UserData != this) return;
        loadedProgress++;
        Log.Info($"Load Config Success:{args.ConfigAssetName}");
    }
    ...
    private void OnLoadDataTableSuccess(object sender, GameEventArgs e)
    {
        ...
        loadedProgress++;
        m_DataTablesCount--;
        Log.Info($"Load DataTable Success:{args.DataTableAssetName}");
    ...
    private void OnLoadDataTableFailure(object sender, GameEventArgs e)
    {
        ...
        Log.Error($"Load DataTable Failed:{args.ErrorMessage}");
    }

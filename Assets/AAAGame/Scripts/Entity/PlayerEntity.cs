...
public class PlayerEntity : CombatUnitEntity
{
    ...
    {
        get => m_PlayerData.Hp;
        protected set => m_PlayerData.Hp = value;
    }
#if UNITY_EDITOR
    ...
    private void Move(float elapseSeconds)
    {
        ...
        //     {
        //         CachedTransform.rotation = Unity.Mathematics.math.slerp(CachedTransform.rotation, Unity.Mathematics.quaternion.LookRotation(dir, Vector3.up),
        //             elapseSeconds * rotationSpeed);
        //     }
        // }

...
namespace UnityGameFramework.Runtime
{
    ...
    public sealed class BaseComponent : GameFrameworkComponent
    {
        ...
        protected override void Awake()
        {
            ...
            InitVersionHelper();
            InitLogHelper();
            Log.Info($"Game Framework Version: {GameFramework.Version.GameFrameworkVersion}");
            Log.Info($"Game Version: {GameFramework.Version.GameVersion} ({GameFramework.Version.InternalGameVersion})");
            ...
            if (m_EditorResourceMode)
            {
                ...
                Log.Info("在此运行期间，游戏框架将使用编辑器资源文件，您应该首先验证这些文件.");
            }
        ...
        private void InitTextHelper()
        {
            ...
            {
                Log.Error($"Can not find text helper type '{m_TextHelperTypeName}'.");
                return;
            }
            ...
            if (textHelper == null)
            {
                Log.Error($"Can not create text helper instance '{m_TextHelperTypeName}'.");
                return;
            }
        ...
        private void InitCompressionHelper()
        {
            ...
            {
                Log.Error($"Can not find compression helper type '{m_CompressionHelperTypeName}'.");
                return;
            }
            ...
            {
                Log.Error($"Can not create compression helper instance '{m_CompressionHelperTypeName}'.");
                return;
            }
        ...
        private void InitJsonHelper()
        {
            ...
            {
                Log.Error($"Can not find JSON helper type '{m_JsonHelperTypeName}'.");
                return;
            }
            ...
            if (jsonHelper == null)
            {
                Log.Error($"Can not create JSON helper instance '{m_JsonHelperTypeName}'.");
                return;
            }

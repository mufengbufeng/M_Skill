...
namespace UnityGameFramework.Runtime
{
    ...
    public sealed class WebRequestComponent : GameFrameworkComponent
    {
        ...
        [SerializeField] private string m_WebRequestAgentHelperTypeName = "UnityGameFramework.Runtime.UnityWebRequestAgentHelper";

        [SerializeField] private WebRequestAgentHelperBase m_CustomWebRequestAgentHelper = null;
        ...
        {
            Log.Warning($"Web request failure, web request serial id '{e.SerialId}', web request uri '{e.WebRequestUri}', error message '{e.ErrorMessage}'.");
